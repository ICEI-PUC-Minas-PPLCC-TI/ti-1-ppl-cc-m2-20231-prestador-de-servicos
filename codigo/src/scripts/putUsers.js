...
[
    ...
    },
    {
        ...
        "categoria": "preparacaoderefeicoes",
        "preco": 150,
        "nota": 3.0,
        "nAvaliacoes": 5,
        "nPedidos": 10,
    ...
    },
    {
        ...
        "categoria": "instalacaodemoveiseprateleiras",
        "preco": 80,
        "nota": 2.5,
        "nAvaliacoes": 2,
        "nPedidos": 5,
...
`
if(localStorage.getItem("prestadores") == null || localStorage.getItem("prestadores") == undefined){
...
if(localStorage.getItem("consumidores") == null || localStorage.getItem("consumidores") == undefined || localStorage.getItem("consumidores") == ""){
    localStorage.setItem("consumidores", JSON.stringify([]))
}